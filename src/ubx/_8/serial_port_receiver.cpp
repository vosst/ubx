...
std::shared_ptr<ubx::_8::Receiver> ubx::_8::SerialPortReceiver::create(const boost::filesystem::path& dev, const std::shared_ptr<Monitor>& monitor)
{
    return std::shared_ptr<SerialPortReceiver>{new SerialPortReceiver{dev, monitor}}->finalize();
}
...
std::shared_ptr<ubx::_8::SerialPortReceiver> ubx::_8::SerialPortReceiver::finalize()
{
    start_read();
